  ...
  return (
    <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:w-80">
      ...
      <Input
        ...
        className="pl-10 pr-4 py-2 w-full rounded-full border-4 border-blue-600 dark:border-blue-500 focus:border-blue-700 dark:focus:border-blue-400 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-slate-700 text-gray-900 dark:text-white text-sm"
      />
    </div>
  );
}
